...
<html>
    ...
    <body>
        <header>
            ...
            <p>Bienvenue sur <b>Filmoteca</b>, où tu peux retrouver toutes sortes de films à travers une archive.</p>
        </header>
        <section>
            <p>Qu'est-ce que vous voulez faire ?</p>
                <a href="Ajouter.html"><button>Ajouter un film</button><br></a>
                <a href="Modifier.html"><button>Modifier un film</button><br></a>
                <a href="Supprimer.html"><button>Supprimer un film</button><br></a>
        </section>
        <footer>
            <p>2024-2025</p>
        </footer>
